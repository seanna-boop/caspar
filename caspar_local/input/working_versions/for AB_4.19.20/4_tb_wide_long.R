...
melt_tb <- melt(tb, id.vars = c("subws_name", "full_name", "period_name", "segment",
                ...
                "branch", "SUBWS", "date_group", "date" , "year", "month", "day", "season",
                "datetime", "time_round", "volume_cf", "rain_mm", "mean_Q_cfs", "sd_Q_cfs",
                "min_Q_cfs", "max_Q_cfs", "volume_liters", "rain_ft", "runoff_ft",
                "runoff_ratio", "vol_shift", "rain_liters"))
